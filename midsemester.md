...
- **State-by-State Face Mask Requirements:** Describes whether or not for each state if mask usage is required. Since the info found was not in csv format nor in a dataframe, the csv file was personally made by me. [Original data source](https://www.aarp.org/health/healthy-living/info-2020/states-mask-mandates-coronavirus.html), [csv file created from data source](https://github.com/jlam01/jlam01-bio/blob/main/maskrequirements.csv), [raw csv]()
